...
const WorkExperience = ({handleChange}) => {
  return (
    <div>
    <h4 className='text-lg font-mediun mg-2'>Work Experience</h4>
    ...
    <div>
        ...
        <InputField handleChange={handleChange} value="Senior or executive-level" title="Senior or executive-level" name="test"/>
