...
const SalaryPage = () => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4'>
      <PageHeader title={"𝐒𝐀𝐋𝐀𝐑𝐘 𝐄𝐒𝐓𝐈𝐌𝐀𝐓𝐄"} path={"Salary"} />
      <div className='mt-5'>
        <div className='search-box p-2 text-center mb-2'>
          <input type="text" name='search' id='search' className='py-2 pl-3 border focus:outline-nae lg:w-6/12 md-4 w-full ' onChange={e => setSearchText(e.target.value)} />
